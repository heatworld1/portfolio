	<p class="finaltitle">Here are some personal downloads that I think everyone should have. So please feel free to download</p>
	<br/>
	<p class="finaltitle">Click the boxes to download the files.</p>
	<hr/> 
	<br/>
	<?php
