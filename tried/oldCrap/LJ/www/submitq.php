<?php
	...
	$message="Your submission was successful.";
	 header("Location:http://localhost/index.php?p=askme");
	echo "$message";
	}

	else{
	$message="Something went wrong, make sure all required fields are filled out and are correct. Please try again <a href='http://localhost/index.php?p=askme'>RETURN</a> ";
	}
