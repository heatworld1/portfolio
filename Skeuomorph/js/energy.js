...
(function($) {
	...
	$.energysaver.end = function() {
		...
		$("#cloud2").css({'background':'url(images/cloud.png) no-repeat'});
		$("#cloud3").css({'background':'url(images/cloud.png) no-repeat'});
		$("#undernav").css({'background':'url(images/long.png)'});
	...
	$.energysaver.start = function() {
       /* $(document.body).css({     backgroundColor:'#000'}); */
		$(document.body).css({'background':'url(images/stars.png) #000 fixed'});			
		$(document.body).animate({backgroundColor:'#000000'}, 700);	
		$("#cloud").css({'background':'url(images/cloud2.png) no-repeat'});
		$("#cloud2").css({'background':'url(images/cloud2.png) no-repeat'});
		$("#cloud3").css({'background':'url(images/cloud2.png) no-repeat'});
		$("#undernav").css({'background':'none'});
		$("#clearfooter").css({'background':'url(images/stars.png) #000 fixed'});
	};
